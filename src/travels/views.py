...
from travels.models import Places, User
...
def index(request):
    ...
    try:
        return render(
            request,
            "travels/index.html",
            {"categories": categories, "travel_points_ids": request.session["travel_points"]},
        )
    except KeyError:
        return render(
            request, "travels/index.html", {"categories": categories, "travel_points_ids": []}
        )
...
def selected_places(request):
    try:
        ...
        return render(
            request,
            "travels/selected_places.html",
            {"places_to_visit": places_to_visit, "places_number": count},
        )

    except KeyError:
        return render(
            request, "travels/selected_places.html", {"places_to_visit": [], "places_number": 0}
        )
